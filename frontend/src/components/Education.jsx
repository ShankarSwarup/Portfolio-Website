    ...
    <section id="education" className="py-24 px-6 bg-background-dark">
      <div className="container mx-auto max-w-5xl">
        ...
        <motion.div
          ...
          className="card p-8 relative overflow-hidden group hover:border-text-muted/30 transition-all duration-300 max-w-3xl"
        >
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6">
            ...
            <div className="text-right flex flex-col items-end gap-2">
              ...
              <span className="px-3 py-1 bg-text-muted/10 text-text-muted text-xs rounded-full border border-text-muted/20 font-mono">
                GPA: 8.38/10 (79.8%)
              </span>
            </div>
          </div>
